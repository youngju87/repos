# Shopify Analytics Implementation Guide

## Table of Contents

- [Team Contacts](#team-contacts)
- [Introduction](#introduction)
- [Data Collection & Web Analytics](#data-collection--web-analytics)
- [Google Tag Manager (GTM) Setup](#google-tag-manager-gtm-setup)
- [3rd Party Implementation](#3rd-party-implementation)
- [DataLayer Design & Theme Snippets](#datalayer-design--theme-snippets)
  - [Shopify to GA4 Event Mapping](#shopify-to-ga4-event-mapping)
  - [Events by Brand](#events-by-brand)
  - [Implementation Instructions](#implementation-instructions)
- [OneTrust & Data Privacy](#onetrust--data-privacy)
- [Testing](#testing)
...
| Name | Email |
|------|-------|
| Valter Violini | [valter_violini@vfc.com](mailto:valter_violini@vfc.com) |
| Justin Young | [justin_young@vfc.com](mailto:justin_young@vfc.com) |
| Joshua Barratt | [joshua_barratt@vfc.com](mailto:joshua_barratt@vfc.com) |
| Denis Zakharych | [denis_zakharych@vfc.com](mailto:denis_zakharych@vfc.com) |
| Nastasia Demarini | [nastasia_demarini@vfc.com](mailto:nastasia_demarini@vfc.com) |
| Sergiu Cetulean | [sergiu_cetulean@vfc.com](mailto:sergiu_cetulean@vfc.com) |
| Renzo Bignami | [renzo_bignami@vfc.com](mailto:renzo_bignami@vfc.com) |
...
Download the extension called [DataLayer Checker Plus](https://chromewebstore.google.com/detail/datalayer-checker-plus/blglfmihmnbhfgfbomofeljmididgfhe). After installation, open its Settings (click the cog icon) and enable -Shopify Custom Pixel DataLayer Checker-.
...
Download [Google Analytics Debugger extension](https://chromewebstore.google.com/detail/google-analytics-debugger/jnkmfdileelhofjcijamephohjechhna), enable it, and visit Eastpak. Events will appear in GA4-s DebugView. You can access DebugView by going to GA4-s *Admin > Property settings > Data display > DebugView*.
