...
- [Introduction](#ShopifyPlaybook:AnalyticsImplementation-Introduction)

- [Data Collection // Web Analytics](#ShopifyPlaybook:AnalyticsImplementation-DataCollection//WebAnalytics)

- [Google Tag Manager (GTM) // Set Up](#ShopifyPlaybook:AnalyticsImplementation-GoogleTagManager(GTM)//SetUp)

- [3rd Party Implementation](#ShopifyPlaybook:AnalyticsImplementation-3rdPartyImplementation)

- [DataLayer Design // Theme Snippets](#ShopifyPlaybook:AnalyticsImplementation-DataLayerDesign//ThemeSnippets)

[Introduction](#ShopifyPlaybook:AnalyticsImplementation-Introduction.1)

- [Shopify â GA4 Mapping Doc](#ShopifyPlaybook:AnalyticsImplementation-ShopifyâGA4MappingDoc)

- [Events â Brand](#ShopifyPlaybook:AnalyticsImplementation-EventsâBrand)

- [Hybrid Snippet + Custom Pixel IMPLEMENTATION](#ShopifyPlaybook:AnalyticsImplementation-HybridSnippet+CustomPixelIMPLEMENTATION)

[STEP BY STEP INSTRUCTIONS](#ShopifyPlaybook:AnalyticsImplementation-STEPBYSTEPINSTRUCTIONS)

- [SNIPPET - ES5](#ShopifyPlaybook:AnalyticsImplementation-SNIPPET-ES5)

[SNIPPET dataLayer](#ShopifyPlaybook:AnalyticsImplementation-SNIPPETdataLayer)

- [Checkout Custom Pixel - ES5](#ShopifyPlaybook:AnalyticsImplementation-CheckoutCustomPixel-ES5)

[customPixel Checkout](#ShopifyPlaybook:AnalyticsImplementation-customPixelCheckout)

- [GTM CONTAINER IMPORT START - JSON](#ShopifyPlaybook:AnalyticsImplementation-GTMCONTAINERIMPORTSTART-JSON)

[GTM Starter Container](#ShopifyPlaybook:AnalyticsImplementation-GTMStarterContainer)

- [âCustom Pixelâ script IMPLEMENTATION _ DO NOT USE](#ShopifyPlaybook:AnalyticsImplementation-âCustomPixelâscriptIMPLEMENTATION_DONOTUSE)

[Custom Pixel (w/ below Click Tracking Enabled) - ES5](#ShopifyPlaybook:AnalyticsImplementation-CustomPixel(w/belowClickTrackingEnabled)-ES5)

- [Advanced Click Tracking () - DEPREICATED](#ShopifyPlaybook:AnalyticsImplementation-AdvancedClickTracking()-DEPREICATED)

[Storefront Snippet](#ShopifyPlaybook:AnalyticsImplementation-StorefrontSnippet)

- [OneTrust dataLayer Tracking () - DEPRICATED](#ShopifyPlaybook:AnalyticsImplementation-OneTrustdataLayerTracking()-DEPRICATED)

[OneTrust dataLayer Tracking](#ShopifyPlaybook:AnalyticsImplementation-OneTrustdataLayerTracking)

- [OneTrust Preference Center ()](#ShopifyPlaybook:AnalyticsImplementation-OneTrustPreferenceCenter())

[OneTrust Preference Center Link](#ShopifyPlaybook:AnalyticsImplementation-OneTrustPreferenceCenterLink)

- [OneTrust // Data Privacy](#ShopifyPlaybook:AnalyticsImplementation-OneTrust//DataPrivacy)

- [dataLayer Events detail and Solution Design ()](#ShopifyPlaybook:AnalyticsImplementation-dataLayerEventsdetailandSolutionDesign())

- [Testing](#ShopifyPlaybook:AnalyticsImplementation-Testing)

[1) Seeing the dataLayer in console.](#ShopifyPlaybook:AnalyticsImplementation-1)SeeingthedataLayerinconsole.)

[2) Seeing the dataLayer in browser extension.](#ShopifyPlaybook:AnalyticsImplementation-2)SeeingthedataLayerinbrowserextension.)

- [3) Once GA4 events are configured in GTM - review network requests.](#ShopifyPlaybook:AnalyticsImplementation-3)OnceGA4eventsareconfiguredinGTM-reviewnetworkrequests.)

- [4) Google Analytics Debugger](#ShopifyPlaybook:AnalyticsImplementation-4)GoogleAnalyticsDebugger)

- [Helpful Shopify Links](#ShopifyPlaybook:AnalyticsImplementation-HelpfulShopifyLinks)
...
| 
[valter_violini@vfc.com](mailto:valter_violini@vfc.com)

 

| 
[justin_young@vfc.com](mailto:justin_young@vfc.com)

 

| 
[joshua_barratt@vfc.com](mailto:joshua_barratt@vfc.com)

 

| 
[denis_zakharych@vfc.com](mailto:denis_zakharych@vfc.com)

 

| 
[nastasia_demarini@vfc.com](mailto:nastasia_demarini@vfc.com)

 

| 
[sergiu_cetulean@vfc.com](mailto:sergiu_cetulean@vfc.com)

 

| 
[renzo_bignami@vfc.com](mailto:renzo_bignami@vfc.com)
...
The sandboxed setup limits direct access to the DOM, making DOM manipulation and scraping difficult. As a result, most standard GTM triggers like element visibility, scroll, history change, click, and JavaScript error wonât work.

- 
**Odd Page URLs**

Custom pixels embedded within a child iFrame lack access to the parent frameâs page information, such as the page URL. This results in odd page URLs containing unwanted strings and identifiers.

- 
**Tracking Codes Inside Custom Pixels**

Since GA4, within the pixelâs iFrame, canât access or modify the parent pageâs content, URL, or linking parameters, cross-domain tracking will not work. If our website/shop (and checkout) are on separate domains, GA4 sessions will not be tracked accurately.

- 
**GTM Preview Mode Does Not Work**

The sandboxed environment prevents Google Tag Managerâs Preview Mode from functioning, which complicates testing and debugging. This requires alternative testing approaches.

- 
**User Engagement Isn't Tracked Properly**

A limitation of custom scripts is that the user_engagement event isnât being recorded correctly. Only a minimal number of these events are collected, and when they are, they lack any engagement time data. As a result, metrics such as Average Engagement Time display as 0s, and all related engagement metrics will be inaccurate and should not be relied upon.
...
- 
***GTM Pixels by Brand (****** FOR REFERENCE - PLEASE SEE CUSTOM PIXEL FOR INSTALLATION ******)***
...
- 
Tags, triggers, variables, and 3rd party vendors currently set up in GTM (JanSport/EastPak/Napapijri)

[**Jansport GTM Review - 120924**](https://docs.google.com/spreadsheets/d/1km_p2pN6O5PV5Qs3V13Q26ZzJO85vV3NMNNjPgUYVxc/edit?usp=sharing)

- 
[**Eastpak GTM Review - 120924**](https://docs.google.com/spreadsheets/d/1S_R8mjBeGqHUzPbbSrnaxLS8dPtGgDcUVgyi50-Q2Yw/edit?usp=sharing)

- 
[**Napapijri GTM Review - 030625**](https://docs.google.com/spreadsheets/d/1zmGUYdHZqOV9h6TQ8o8fjjBTupEQchCqWrx0OvjjqeY/edit?usp=sharing)

- 
[**Kipling NORA GTM Review - 041725**](https://docs.google.com/spreadsheets/d/13M2Zxf4GU5g9IL3fMN1YYdvqxmX3D7Uk4gzcfRsdevM/edit?usp=sharing)

- 
[**Kipling EMEA GTM Review - 041725**](https://docs.google.com/spreadsheets/d/1XE6aGXucBkGQySGBLgjwbaKrz4qAU9U7gqiAVIeUhQ8/edit?usp=sharing)

- 
[**Icebreaker APAC GTM Review - 071825**](https://docs.google.com/spreadsheets/d/1EcUJ-BodlNn9JSwkcTsz-cuLodPUaJpCWC6qjknC_4c/edit?usp=sharing)

- 
[**Icebreaker EMEA GTM Review - 071825**](https://docs.google.com/spreadsheets/d/17PIsGWEzvDNVxy_gLWTlXmswZaNYtvCiayMIC-qsZWI/edit?usp=sharing)

- 
[**Icebreaker NORA GTM Review - 071825**](https://docs.google.com/spreadsheets/d/1AQC_YjsDr6Qiqy7Z--dXzNmcNHGPsBpv0PXIKin2nTg/edit?usp=sharing)
...
| 
**NAPA EMEA STATUS / NOTES**

 
| 
**KIPLING NORA STATUS / NOTES**

 
| 
**KIPLING EMEA STATUS / NOTES**

 
| 
**ICEBREAKER NORA STATUS / NOTES**

 
| 
**ICEBREAKER EMEA STATUS / NOTES**

 
| 
**ICEBREAKER APAC STATUS / NOTES**

 
| 
**EASTPAK EMEA STATUS / NOTES**

 
| 
**DICKIES NORA STATUS / NOTES**

 
| 
**DICKIES EMEA STATUS / NOTES**
...
## âCustom Pixelâ script IMPLEMENTATION _ DO NOT USE 
...
      var paymentMethod = checkout && checkout.paymentMethod; // placeholderâverify property name in your data
...
Next, add render snippet with file in 'theme' (labeled whatever it is called in the snippet file) (in )
...
- 
[Your Privacy Choices](#trustTool)

## **OneTrust // Data Privacy**

- 
Data privacy and compliance (e.g., GDPR, CCPA) will be handled by OneTrust:

[OneTrust Knowledge Article](https://my.onetrust.com/s/article/UUID-a19a7752-4386-f65f-f109-fd6bde724bcf?language=en_US)
...
[https://eastpak-us.myshopify.com?preview_theme_id=168924905665](https://eastpak-us.myshopify.com/?preview_theme_id=168924905665)

- 
[https://eastpak-dev.myshopify.com?preview_theme_id=147130679544](https://eastpak-dev.myshopify.com/?preview_theme_id=147130679544)

- 
*To Preview: Append the following to the end of the URL - **?otgeo=us,ct&otpreview=true&otreset=true**. (e.g. [https://eastpak-us.myshopify.com?preview_theme_id=168924905665&otgeo=us,ct&otpreview=true&otreset=true](https://eastpak-us.myshopify.com/?preview_theme_id=168924905665&otgeo=us,ct&otpreview=true&otreset=true))

## **dataLayer Events detail and Solution Design (****)**

- 
[General implementation requirement](https://vf-corp.atlassian.net/wiki/spaces/AN/pages/80447584/General+implementation+requirement)

- 
[Data Layer Solution Design Document](https://vf-corp.atlassian.net/wiki/spaces/AN/pages/80449695/Data+Layer+Solution+Design+Document)

[Data Collection Mechanisms](https://vf-corp.atlassian.net/wiki/spaces/AN/pages/80447628/Data+Collection+Mechanisms)

- 
[Data Layer Architecture](https://vf-corp.atlassian.net/wiki/spaces/AN/pages/80447640/Data+Layer+Architecture)

[Data Objects and Attributes](https://vf-corp.atlassian.net/wiki/spaces/AN/pages/80447968/Data+Objects+and+Attributes)

- 
[Events](https://vf-corp.atlassian.net/wiki/spaces/AN/pages/80456742/Events)

## **Testing**

#### 1) Seeing the dataLayer in console.

You will notice that there are now sandboxes available. Choose the one that contains the word âCUSTOM-â directly followed by some digits: e.g., web-pixel-sandbox-CUSTOM-123456789. Once you select the correct sandbox, type âdataLayerâ (without quotes) in the console and hit enter. You should see populated values there.

##### 2) Seeing the dataLayer in browser extension.

Download the extension called [DataLayer Checker Plus](https://chromewebstore.google.com/detail/datalayer-checker-plus/blglfmihmnbhfgfbomofeljmididgfhe). After installation, open its Settings (click the cog icon) and enable âShopify Custom Pixel DataLayer Checkerâ.

#### 3) Once GA4 events are configured in GTM - review network requests.

Troubleshoot the setup by using browserâs âNetwork tabâ. Look at outgoing network requests, open dev tools, navigate to the Network tab, and filter the requests by collect?v=2 to display Google Analytics 4 requests.

#### 4) Google Analytics Debugger

Download [Google Analytics Debugger extension](https://chromewebstore.google.com/detail/google-analytics-debugger/jnkmfdileelhofjcijamephohjechhna), enable it, and visit Eastpak. Events will appear in GA4âs DebugView. You can access DebugView by going to GA4âs *Admin > Property settings > Data display > DebugView*.

## **Helpful Shopify Links**

- 
[List of Shopify Standard Events](https://shopify.dev/docs/api/web-pixels-api/standard-events)
...
- 
[GA Ecom Measurement](https://developers.google.com/analytics/devguides/collection/ga4/ecommerce)

 

------=_Part_10_1271018755.1767719653321
Content-Type: application/octet-stream
Content-Transfer-Encoding: base64
Content-Location: file:///C:/4eb0b9c3f22e598cb704b78a96eba155d9ea24d03083ace82fe3faea0898ff4e

iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAABGdBTUEAALGPC/xhBQAAAAlwSFlz
AABuugAAbroB1t6xFwAAAVlpVFh0WE1MOmNvbS5hZG9iZS54bXAAAAAAADx4OnhtcG1ldGEgeG1s
...
------=_Part_10_1271018755.1767719653321
Content-Type: application/octet-stream
Content-Transfer-Encoding: base64
Content-Location: file:///C:/a8c298b27c3f830c3b0829589a07b1c04daa67fec53b3f51fd171fe298b5b287
...
------=_Part_10_1271018755.1767719653321
Content-Type: application/octet-stream
Content-Transfer-Encoding: base64
Content-Location: file:///C:------=_Part_10_1271018755.1767719653321
Content-Type: application/octet-stream
Content-Transfer-Encoding: base64
Content-Location: file:///C:/5d1b6d3817f47bec50f1167403fc77affb95edb8f2d79e17e21c03a7d9fc4212
...

AAAAAAAAAAAAAAAAAAAAAACAkv0LOsDjfobpWfwAAAAASUVORK5CYII------=_Part_10_1271018755.1767719653321
Content-Type: application/octet-stream
Content-Transfer-Encoding: base64
Content-Location: file:///C:/e452d7bfcd9045f5ec7347d3bc55bd39c19d7728bdf11906faa6bce24302eb46

/9j/4AAQSkZJRgABAgAAAQABAAD/wAARCAD6AgYDAREAAhEBAxEB/9sAQwAIBgYHBgUIBwcHCQkI
...

------=_Part_10_1271018755.1767719653321
Content-Type: application/octet-stream
Content-Transfer-Encoding: base64
Content-Location: file:///C:/da65b889d7bb48b07a52c606a2a2dab915b7ec39d70d4118c8f3b7ad80d619d8
...
------=_Part_10_1271018755.1767719653321--