...
export type RuleType =
  | 'presence'      // Tag/event presence validation
  | 'payload'       // Network payload validation
  | 'order'         // Load order and timing
  | 'consent'       // Consent compliance
  | 'data-layer'    // Data layer validation
