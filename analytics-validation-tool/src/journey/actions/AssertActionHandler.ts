 ...
 */
export class AssertActionHandler extends BaseActionHandler<AssertAction> {
    ...
    try {
      ...
      if (!passed) {
        return this.createFailureResult(
          ...
          duration,
          new Error(
            `Assertion failed: ${action.message || 'Assertion did not pass'}\n` +
   ...
   */
  private checkAssertion(actualValue: any, action: AssertAction): boolean {
