...
exports.WaitActionHandler = void 0;
const ActionHandler_1 = require("./ActionHandler");
/**
 * Handler for wait actions
 */
class WaitActionHandler extends ActionHandler_1.BaseActionHandler {
    type = 'wait';
     ...
     */
    async waitForDataLayer(page, action) {
        ...
        await page.waitForFunction(({ dlName, evtName }) => {
     ...
     */
    async waitForNetwork(page, action) {
...
exports.WaitActionHandler = WaitActionHandler;
//# sourceMappingURL=WaitActionHandler.js.map