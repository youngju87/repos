...
exports.COMMON_PATTERNS = exports.CONFIDENCE = exports.BaseDetector = void 0;
...
class BaseDetector {
     ...
     */
    createEvidence(method, matched, value, confidence, context) {
        return {
            method,
            matched,
            value,
     ...
     */
    determineLoadMethod(scriptUrls, context) {
     ...
     */
    extractIdsFromParams(request, paramNames) {
        const ids = {};
